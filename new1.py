...
def signUpPage():
    ...
    pas = Entry(sup_frame, bg='#d3d3d3', fg='black',
    ...
    log = Button(sup_frame, text='Already have a Account?', padx=5,
...
def quiz(questions,solutions):
    ...
    a = Radiobutton(easy_frame, text="", font="calibri 10",
                    value="", variable=var, bg="white")
    a.place(relx=0.5, rely=0.42, anchor=CENTER)
    # a.deselect()
    b = Radiobutton(easy_frame, text="", font="calibri 10",
                    value="", variable=var, bg="white")
    b.place(relx=0.5, rely=0.52, anchor=CENTER)
    # b.deselect()
    c = Radiobutton(easy_frame, text="", font="calibri 10",
                    value="", variable=var, bg="white")
    c.place(relx=0.5, rely=0.62, anchor=CENTER)
    # c.deselect()
    d = Radiobutton(easy_frame, text="", font="calibri 10",
                    value="", variable=var, bg="white")
    d.place(relx=0.5, rely=0.72, anchor=CENTER)
    # d.deselect()
    # print(var.get())
